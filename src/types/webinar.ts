...
export const DEFAULT_WEBINAR_CONFIG: Omit<WebinarConfig, 'id' | 'createdAt' | 'updatedAt'> = {
  ...
  regFormBackground: '#ffffff',
  regFormTextColor: '#1a1a1a',
  ...
  regFormHeadlineFontSize: '1.75rem',
  regFormBodyFontSize: '1rem',
  regFormHeadlineColor: '#050505',
  regFormHeadlineFontWeight: '700',
  regFormBulletColor: '#018de4',
  regFormSubheadlineColor: '#485160',
